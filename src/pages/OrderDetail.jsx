...
const OrderDetail = () => {
  ...
  <button
    ...
    className="w-full sm:w-auto px-4 py-2 bg-green-500 text-white rounded shadow"
  >
    Unduh Nota
  </button>
  ...
  <div id="invoice">
    ...
    <div className="bg-white shadow rounded-lg p-4 md:p-6 mb-4 md:mb-6">
      <h2 className="text-xl md:text-2xl font-semibold mb-4">Detail Pesanan</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-sm md:text-lg">
            <span className="font-semibold">Tanggal:</span> {format(new Date(order.created_at), "dd MMM yyyy HH:mm", { locale: id })}
          </p>
        </div>
        <div>
          <p className="text-sm md:text-lg break-words">
    ...
    {order.shipment && (
      <div className="bg-white shadow rounded-lg p-4 md:p-6 mb-4 md:mb-6">
        <h3 className="text-xl md:text-2xl font-semibold mb-4">Detail Pengiriman</h3>
    ...
    <div className="bg-white shadow rounded-lg p-4 md:p-6">
      <h3 className="text-xl md:text-2xl font-semibold mb-4">Produk Pesanan</h3>
        ...
        <table className="w-full min-w-full table-auto border-collapse">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border p-2 md:p-3 text-left">Qty</th>
          ...
          <tbody>
            {order.order_items.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="border p-2 md:p-3 break-words">{item.product.product_name}</td>
