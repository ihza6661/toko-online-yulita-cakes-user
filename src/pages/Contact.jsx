...
const Contact = () => {
  ...
  return (
    <div className="prose prose-pink dark:prose-invert lg:prose-lg max-w-none">
      <div className="accent pb-1 px-4 sm:px-8">
        <motion.div
        ...
        >
          ...
          <div className="text-center md:text-start text-2xl border-t border-pink-200 pt-24 sm:pt-28 lg:pt-36">
            ...
            <p className="text-sm sm:text-base">
              Ada pertanyaan atau permintaan khusus? Jangan ragu untuk
          ...
          <div className="my-12 lg:my-16 flex flex-col md:flex-row items-center justify-center md:items-start gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-md w-full gap-6">
              ...
              <div className="w-full">
                <h3 className="font-semibold text-2xl sm:text-3xl text-pink-900 dark:text-pink-500 tracking-wide mb-2">
                  Kontak
                </h3>
                <div className="flex justify-center sm:justify-start">
                  <p className="leading-relaxed flex flex-col gap-3 text-sm sm:text-lg">
                    <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-gradient-to-r from-pink-500 to-pink-700 text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-sm sm:text-base"
              >
                Chat via WhatsApp
              </a>
            </div>
      ...
      {/* Outlet Section */}
      <div className="p-10 flex flex-col mb-20 gap-8 px-0 sm:px-36 mx-auto items-center justify-center">
        {/* Title Centered */}
        <div className="text-center text-xl py-6 text-pink-800 w-full">
        ...
        {/* Locations Grid */}
        <div className="flex flex-col md:flex-row flex-wrap items-center gap-6 text-sm md:w-1/2 justify-center">
