    ...
    <>
     ...
     <div className="container mx-auto text-center">
       ...
       >
         ...
         Cari koleksi kue buatan tangan kami atau pesan desain kustom untuk acara spesial Anda.
         </p>
         <div className="flex flex-col sm:flex-row gap-4 justify-center">
           <a href="/collection" className="bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-md font-medium transition-colors">
           Belanja Sekarang
           </a>
